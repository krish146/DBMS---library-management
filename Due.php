...
<div > Borrowed books due <div>
            <form id="Due Date of Books" method="post" >
                <br>
                <label  for="DueDate">Date Sanctioned: </label><input name='DueDate' placeholder="due date" id="name" type="date" /><br>
...
document.getElementById('showtext').addEventListener('click', function() {
    ...
    var tableName = 'borrowedbookslog';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $BookName = $_POST["DueDate"];
    $BookID= $_POST["BookID"];
   

    $sql = "INSERT INTO borrowedbookslog ( DueDate, BookID) VALUES ('$DueDate', '$BookID')";
